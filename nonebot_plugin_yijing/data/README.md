...
- 六十四卦名、上下卦、卦序、卦辞和卦关系已经完整提供。
- 八卦、六爻骨架、来源、起卦规则、解读规则已经建模。
- 384 条爻辞、64 条彖传、64 条大象、384 条小象已经由脚本从公开来源抓取并写入。
- 文言传按经典边界仅收乾、坤两卦；系辞、说卦、序卦、杂卦按章节或篇章拆分。
- 古籍正文补录脚本为 [`../../scripts/fetch_wikisource_corpus.py`](../../scripts/fetch_wikisource_corpus.py)；资料正文禁止用 AI 生成。
